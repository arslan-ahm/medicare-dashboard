...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full p-4 overflow-hidden bg-white border border-slate-400 group-hover:border-slate-700 group-hover:shadow-xl shadow-sm relative z-20",
        className
      )}
    >
